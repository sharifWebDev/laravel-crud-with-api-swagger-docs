<aside class="main-sidebar sidebar-dark-primary elevation-4" style="z-index:10000 !important">
    ...
    <div class="mt-0 sidebar">
        <div class="mt-0 mb-4 form-inline">
            <div class="bg-transparent input-group" data-widget="sidebar-search"> <input class="bg-transparent form-control form-control-sidebar" type="search" placeholder="Search" aria-label="Search">
                <div class="input-group-append"> <button class="bg-transparent btn btn-sidebar"> <i class="fas fa-search fa-fw"></i> </button> </div>
            </div>
...
<li class="nav-item"> 
            ...
            <i class="nav-icon fas fa-angle-double-right"></i> <p>Students</p>
</a>
</li>
  

                <br> 
                <p class="text-white bold"> --Reports--</p>
                <hr> 
